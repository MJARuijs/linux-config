...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 1, bezier = "md3_decel", style = "popin 60%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1, bezier = "md3_accel", style = "popin 60%" })
